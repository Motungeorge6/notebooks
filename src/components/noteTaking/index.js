    ...
    <div className="flex h-screen">
      ...
      <div className="flex flex-col w-full relative">
          <div className="flex-1 relative">
            <div className="w-5/6  bg-[#4A4AFA] flex flex-col justify-end rounded-lg shadow-lg m-0 h-[159px] mt-10">
              <div className="w-full h-full flex flex-row justify-end">
                ...
                <div className="fixed h-full mt-28">
                  <button
                    className="relative  text-gray-500 font-bold py-2 px-4 rounded flex items-center"
                    onClick={() => {
          ...
          {showButtons && (
            <div className="flex justify-end mr-6 mt-4">
              ...
              <button
                onClick={handleSave}
                className="bg-[#4A4AFA] text-[#000000] font-normal py-2 px-4 rounded-lg"
              >
                Save
              </button>
            </div>
            ...
            <div className="fixed top-0 left-0 w-full h-full bg-black bg-opacity-50 flex justify-center items-center">
              <div className="bg-white p-8 rounded-lg shadow-lg flex flex-col justify-center items-center">
                ...
                <div className="flex justify-end">
                  <button onClick={handleGoHome} className="bg-[#F7F7F7] text-[#000000] text-xs font-normal py-2 px-4 mr-4 rounded-xl">
                    Go Home
                  </button>
                  <button onClick={handleWriteNewNote} className="bg-[#4A4AFA] text-white font-normal text-xs py-2 px-4 rounded-xl">
                    Write New Note
                  </button>
                </div>
              </div>
