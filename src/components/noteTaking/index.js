...
function NewNotes() {
  ...
  // Save the note and show confirmation modal
  const handleSave = () => {
  ...
  // Navigate to notes listing page
  const handleGoHome = () => {
    navigate("/notes");
  };

  // Reload the page to write a new note
  ...
  return (
    <div className="flex md:flex-row flex-col md:h-screen">
      ...
      <div className="flex-1 relative ">
        ...
        <div className=" bg-[#4A4AFA] flex flex-col justify-end rounded-lg shadow-lg m-0 h-[159px] mt-10 md:mx-10 md:mb-6">
        ...
        <div className="p-4 md:px-10 md:py-6">
          <input
            ...
            className="block w-full mt-4 px-4 py-2 focus:outline-none focus:border-blue-500"
          />
